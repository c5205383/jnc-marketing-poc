...
/**
 * SpecifiedFieldNotExistedException can be thrown during the specified field doesn't existed in specific entity, normally it represents the
 * fields in JPA entity.
 *
